...
final class Pooki_Theme_Init {
	...
	private function load_dependencies() {
		...
		require_once get_template_directory() . '/inc/core/class-pooki-woocommerce-single.php';
		new Pooki_WooCommerce_Single();

		require_once get_template_directory() . '/inc/core/class-pooki-woocommerce-forms.php';
		new Pooki_WooCommerce_Forms();
